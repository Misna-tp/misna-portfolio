  ...
  import { SiFlutter, SiDart, SiJavascript, SiMysql, SiExpress, SiNodedotjs, SiGit, SiGithub, SiPostman , SiGoogleplay} from "react-icons/si";
import { VscVscode } from "react-icons/vsc";
 ...
 <SkillCard
  name="App Deployment"
  icon={<SiGoogleplay className="text-blue-500" />}
/>
  </div>
  </div>
      </section>
